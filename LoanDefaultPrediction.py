...
plt.title('Target Class Distribution')   #exploring the target class balance
...
sns.heatmap(corr, cmap='coolwarm', annot=True)   #looking at correlations for numerical features only
